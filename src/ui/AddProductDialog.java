...
/**
 * Modal dialog for adding new products to the inventory.
 */
public class AddProductDialog extends JDialog {
    ...
    public AddProductDialog(JFrame parent, StoreSystem system, ProductsView parentView) {
    ...
    private void updateDynamicFields(String category) {
        ...
        if (category.equals("Zapato") || category.equals("Ropa")) {
            ...
            JComboBox<String> typeComboBox = new JComboBox<>(getEnumNames(Accessories.TypeAccessories.class));
            typeComboBox.setPreferredSize(LARGE_INPUT_SIZE);
            specificTypeInput = typeComboBox;
        ...
        try {
            ...
            switch (category) {
                case "Zapato" -> {
                    ...
                    newProduct = new Shoe(
                         newId, name, price, stock, description,
                ...
                case "Accesorio" -> {
                    ...
                    newProduct = new Accessories(
                         newId, name, price, stock, description,
                         specificField1.getText(), 
                         Accessories.TypeAccessories.valueOf(typeValue)
                    );
                }
            }
