...
/**
 * The main application window hosting the sidebar and dynamic content views.
 */
public class MainFrame extends JFrame {
    ...
    public MainFrame(StoreSystem system, User authenticatedUser) {
        this.system = system;
        ...
        addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent evt) {
                ...
                if (confirm == JOptionPane.YES_OPTION) {
                    system.saveProducts(); // Save state before exit
                    System.exit(0);
                }
            }
        });
    ...
    private JPanel createSidebarButtons() {
        ...
        // Using Spanish keys to maintain UI consistency with user requirements
    ...
    private void handleNavigation(String viewKey, JButton clickedButton) {
        resetAllButtons();
        ...
        switch (viewKey) {
            case "Dashboard" -> setMainContent(new DashboardView(system));
            case "Productos" -> setMainContent(new ProductsView(system));
            case "Ventas" -> setMainContent(new SalesView(system));
            case "Facturas" -> setMainContent(new InvoicesView(system));
            case "Gestión de usuarios" -> {
                if (authenticatedUser.getRole() == Role.ADMIN) {
                    setMainContent(new UsersView(system));
                } else {
                    // Revert button style if access denied
